...
{
    /// <summary>The current app-wide mode. Defaults to <see cref="TweakerMode.Normal"/>.</summary>
    TweakerMode CurrentMode { get; }

    /// <summary>
    /// The active Builder target. Only meaningful while <see cref="CurrentMode"/> is
    /// <see cref="TweakerMode.Builder"/>. Defaults to <see cref="BuilderTarget.Config"/>.
    /// </summary>
