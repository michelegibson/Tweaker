...
<#
  ...
  .NOTES
      ...
      Credits:
      - Legacy Edge removal based on work by ishad0w:
      - Chromium Edge removal based on work by FR33THY:
      - Edge protocol redirect based on OpenWebSearch by AveYo:
#>
...
# Setup logging
$logFolder = ""C:\ProgramData\Tweaker\Logs""
...
function Install-EdgeProtocolRedirect {
    ...
    $scriptsDir = ""C:\ProgramData\Tweaker\OpenWebSearch""
...
""@
    ...
    Register-ScheduledTask -TaskName $repairTaskName -TaskPath ""\Tweaker\"" -Action $repairAction -Trigger $repairTrigger -Settings $repairSettings -Principal $repairPrincipal -Force | Out-Null
...
$stubPath = ""C:\ProgramData\Tweaker\OpenWebSearch\ie_to_edge_stub.exe""
