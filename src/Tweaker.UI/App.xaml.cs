...
using Tweaker.UI.Features.Common.Extensions.DI;
...
public partial class App : Application
{
    ...
    protected override void OnLaunched(Microsoft.UI.Xaml.LaunchActivatedEventArgs args)
    {
        ...
        try
        {
            ...
            _host = CompositionRoot.CreateTweakerHost().Build();
            ...
            try
            {
                ...
                // Start file logging to C:\ProgramData\Tweaker\Logs
                try
                {
                    ...
                    if (_logService is Tweaker.Core.Features.Common.Services.LogService concreteLogService)
                    {
                    ...
                    _logService?.LogInformation("Modune application starting...");
                }
