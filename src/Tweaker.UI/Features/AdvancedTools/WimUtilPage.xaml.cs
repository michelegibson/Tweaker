...
namespace Tweaker.UI.Features.AdvancedTools;
...
public sealed partial class WimUtilPage : Page
{
    ...
    public WimUtilPage()
    {
        ...
        ActualThemeChanged += (_, _) => UpdateTweakerXmlCardIcon();
        UpdateTweakerXmlCardIcon();

        // PageUp/PageDown fast-scroll + Home/End jump (issue #581).
        PageScrollHelper.Attach(this, PageScrollView);
    }

    private void UpdateTweakerXmlCardIcon()
    {
        const string uri = "ms-appx:///Assets/AppIcons/modune-mark.png";
        TweakerXmlCardIcon.Source = new BitmapImage(new Uri(uri));
    }
    ...
    private void SubscribeToActionCards()
    {
        ...
        WizardActionCard?[] cards =
        {
            ...
            ViewModel.GenerateTweakerXmlCard, ViewModel.DownloadXmlCard, ViewModel.SelectXmlCard,
