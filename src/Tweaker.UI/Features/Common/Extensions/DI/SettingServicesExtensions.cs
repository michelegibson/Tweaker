...
using Tweaker.Core.Features.Customize.Interfaces;
...
using Tweaker.Infrastructure.Features.Customize.Services;
using Tweaker.Infrastructure.Features.Optimize.Services;
using Tweaker.Infrastructure.Features.SoftwareApps.Services;
using Tweaker.Infrastructure.Features.SoftwareApps.Services.WinGet;
...
{
    /// <summary>
    /// Registers all setting services for the Tweaker application.
    /// </summary>
