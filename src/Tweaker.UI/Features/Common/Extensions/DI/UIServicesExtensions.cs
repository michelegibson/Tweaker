...
using Tweaker.UI.Features.AdvancedTools.Services;
...
using Tweaker.UI.Features.Optimize;
...
using Tweaker.UI.Features.SoftwareApps.Services;
...
{
    /// <summary>
    /// Registers UI-specific services for the Tweaker WinUI 3 application.
    /// </summary>
    ...
    public static IServiceCollection AddUIServices(this IServiceCollection services)
    {
        ...
        // Application Close Service (Singleton - Handles application shutdown)
        ...
        services.AddSingleton<IRegeditLauncher, Tweaker.UI.Features.Common.Utilities.RegeditLauncher>();
