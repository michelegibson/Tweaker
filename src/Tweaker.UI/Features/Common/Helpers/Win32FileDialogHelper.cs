...
namespace Tweaker.UI.Features.Common.Helpers;
...
public static class Win32FileDialogHelper
{
    ...
    /// <param name="window">The parent window.</param>
    /// <param name="title">The dialog title.</param>
    /// <param name="filterName">The filter display name (e.g., "Modune Configuration Files").</param>
    /// <param name="filterPattern">The filter pattern (e.g., "*.tweaker").</param>
