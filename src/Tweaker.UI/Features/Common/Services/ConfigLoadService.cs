...
using Tweaker.Core.Features.Common.Helpers;
...
public class ConfigLoadService : IConfigLoadService
{
        ...
        try
        {
            ...
            if (loadedConfig.Version != "2.0")
            {
                ...
                await _dialogService.ShowInformationAsync(
                    ...
                    ?? $"This configuration file version ({versionText}) is not compatible with this version of Modune.",
    ...
    public async Task<UnifiedConfigurationFile?> LoadRecommendedConfigurationAsync()
    {
        try
        {
            ...
            var resourceName = "Tweaker.UI.Resources.Configs.Tweaker_Recommended_Config.tweaker";
    ...
    public async Task<UnifiedConfigurationFile?> LoadWindowsDefaultsConfigurationAsync()
    {
        try
        {
            ...
            var resourceName = isWindows11
                ? "Tweaker.UI.Resources.Configs.Tweaker_Default_Config_Windows11_25H2.tweaker"
                : "Tweaker.UI.Resources.Configs.Tweaker_Default_Config_Windows10_22H2.tweaker";
