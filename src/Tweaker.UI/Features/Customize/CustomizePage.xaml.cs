...
using Tweaker.UI.Features.Common.Helpers;
using Tweaker.UI.Features.Common.Interfaces;
using IConfigReviewService = Tweaker.Core.Features.Common.Interfaces.IConfigReviewService;
using ILocalizationService = Tweaker.Core.Features.Common.Interfaces.ILocalizationService;
using IUserPreferencesService = Tweaker.Core.Features.Common.Interfaces.IUserPreferencesService;
using IBulkSettingsActionService = Tweaker.Core.Features.Common.Interfaces.IBulkSettingsActionService;
using Tweaker.UI.Features.Common.Models;
using Tweaker.UI.Features.Customize.Pages;
using Tweaker.UI.Features.Customize.ViewModels;

namespace Tweaker.UI.Features.Customize;
...
public sealed partial class CustomizePage : Page
{
    ...
    private async void ApplyRecommended_Click(object sender, RoutedEventArgs e)
    {
        ...
        else if (_applicationModeService?.CurrentMode == TweakerMode.Builder)
    ...
    private List<Tweaker.UI.Features.Optimize.ViewModels.SettingItemViewModel> GetCurrentPageSettingViewModels()
    {
        var settings = new List<Tweaker.UI.Features.Optimize.ViewModels.SettingItemViewModel>();
