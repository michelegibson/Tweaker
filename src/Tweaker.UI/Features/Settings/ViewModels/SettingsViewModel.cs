...
namespace Tweaker.UI.Features.Settings.ViewModels;
...
public partial class SettingsViewModel : ObservableObject, IDisposable
{
    ...
    private TweakerTheme _selectedTheme;
    public TweakerTheme SelectedTheme
    {
        get => _selectedTheme;
        set
        {
    ...
    {
        Themes.Clear();
        Themes.Add(new ThemeOption(TweakerTheme.System, GetThemeDisplayName(TweakerTheme.System)));
        Themes.Add(new ThemeOption(TweakerTheme.LightNative, GetThemeDisplayName(TweakerTheme.LightNative)));
        Themes.Add(new ThemeOption(TweakerTheme.DarkNative, GetThemeDisplayName(TweakerTheme.DarkNative)));
    }

    /// <summary>
    /// Gets the localized display name for a theme.
    /// </summary>
    private string GetThemeDisplayName(TweakerTheme theme) => theme switch
    {
        TweakerTheme.System => _localizationService.GetString("Theme_System") ?? "System",
        TweakerTheme.LightNative => _localizationService.GetString("Theme_LightNative") ?? "Light",
        TweakerTheme.DarkNative => _localizationService.GetString("Theme_DarkNative") ?? "Dark",
        _ => theme.ToString()
    };
    ...
    public string PageDescription => _localizationService.GetString("Settings_Description") ?? "Configure Modune application preferences";
    ...
    /// </summary>
    private void OnSelectedThemeChanged(TweakerTheme value)
    {
...
public partial class ThemeOption : ObservableObject
{
    ...
    public TweakerTheme Theme { get; }

    public ThemeOption(TweakerTheme theme, string displayText)
    {
        Theme = theme;
