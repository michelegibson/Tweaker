...
public sealed partial class WindowsAppsHelpContent : UserControl
{
    ...
    public WindowsAppsHelpContent(ILocalizationService localizationService)
    {
        ...
        TweakerStatusLabel.Text = localizationService.GetString("Help_TweakerStatus");
        ...
        LearnMoreLink.NavigateUri = new System.Uri("https://tweaker.net/docs/features/software-apps/windows-apps.html");
    }
