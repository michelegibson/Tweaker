...
using Tweaker.UI.Features.Common.Controls;
...
public sealed partial class MainWindow : Window, INotifyPropertyChanged
{
    ...
    /// and wires up ApplicationCloseService for proper shutdown.
    /// </summary>
    ...
    private void ModeButton_Click(object sender, RoutedEventArgs e)
    {
        ...
        TweakerMode? target = tag switch
        {
            "Normal" => TweakerMode.Normal,
            "Builder" => TweakerMode.Builder,
            "ConfigReview" => TweakerMode.ConfigReview,
            _ => null
        };
    ...
    private void TitleBarAccelerator_Invoked(KeyboardAccelerator sender, KeyboardAcceleratorInvokedEventArgs args)
    {
        var button = sender.Key switch
        {
            VirtualKey.Number1 => WindowsFilterButton,
                        VirtualKey.Number2 => BugReportButton,
            VirtualKey.Number3 => DocsButton,
            _ => (Button?)null
        };
