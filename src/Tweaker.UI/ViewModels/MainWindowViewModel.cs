...
public partial class MainWindowViewModel : ObservableObject, IDisposable
{
    ...
    public TweakerMode CurrentMode => _applicationModeService.CurrentMode;
    public bool IsNormalMode => CurrentMode == TweakerMode.Normal;
    public bool IsBuilderModeActive => CurrentMode == TweakerMode.Builder;
    public bool IsConfigReviewModeActive => CurrentMode == TweakerMode.ConfigReview;
        ...
        IUserPreferencesService userPreferencesService)
    {
        ...
        AppIconSource = "ms-appx:///Assets/AppIcons/modune-mark.png";
        VersionInfo = "Modune";
    ...
    private void OnLanguageChanged(object? sender, EventArgs e)
    {
        ...
        OnPropertyChanged(nameof(TweakerModeLabel));
        ...
        OnPropertyChanged(nameof(NavSystemSectionText));
    ...
    public string AppTitle =>
        _localizationService.GetString("App_Title") ?? "Modune";

    public string AppSubtitle =>
        _localizationService.GetString("App_By") ?? "Windows Control Studio";

    // Mode switcher label + per-mode labels and tooltips
    public string TweakerModeLabel => _localizationService.GetString("Mode_Switcher_Label") ?? "Workspace";
    ...
    public string NavSystemSectionText =>
        _localizationService.GetString("Theme_System") ?? "System";
    ...
    /// </summary>
    public async Task RequestSwitchModeAsync(TweakerMode target)
    {
        ...
        bool leavingBuilderWithEdits = _applicationModeService.CurrentMode == TweakerMode.Builder
            && _applicationModeService.GetBuilderEdits().Count > 0;
        bool leavingReview = _applicationModeService.CurrentMode == TweakerMode.ConfigReview;
        ...
        if (target == TweakerMode.Builder && !await ShowBuilderIntroIfNeededAsync())
        {
            RaiseModeProperties();
            return;
        }
        if (target == TweakerMode.ConfigReview && !await ShowConfigReviewIntroIfNeededAsync())
        {
            RaiseModeProperties();
            return;
        }
    ...
    /// </summary>
    private void OnThemeChanged(object? sender, TweakerTheme theme)
    {
        UpdateAppIconForTheme();
    }
    ...
    public void UpdateAppIconForTheme()
    {
        ...
        // The full-color mark is contrast-safe in both themes.
        AppIconSource = "ms-appx:///Assets/AppIcons/modune-mark.png";
    }
