...
public class ComboBoxResolverTests
{
    ...
    private static IReadOnlyList<Tweaker.Core.Features.Common.Models.ComboBoxOption> BuildOptions(
        string[] displayNames,
        Dictionary<int, Dictionary<string, object?>>? mappings)
    {
        var options = new List<Tweaker.Core.Features.Common.Models.ComboBoxOption>(displayNames.Length);
    ...
    private static IReadOnlyList<Tweaker.Core.Features.Common.Models.ComboBoxOption> BuildOptionsFromMappings(
        Dictionary<int, Dictionary<string, object?>> mappings)
    {
