...
public class ScheduledTaskServiceTests
{
    ...
    public async Task RegisterScheduledTaskAsync_EnsuresScriptFileExists_WhenMissing()
    {
        var script = new RemovalScript
        {
            ...
            TargetScheduledTaskName = "TestTask",
            ActualScriptPath = @"C:\ProgramData\Tweaker\Scripts\TestTask.ps1",
        };
        ...
        _mockFileSystem.Setup(f => f.GetDirectoryName(script.ActualScriptPath))
            .Returns(@"C:\ProgramData\Tweaker\Scripts");
        _mockFileSystem.Setup(f => f.DirectoryExists(@"C:\ProgramData\Tweaker\Scripts"))
            .Returns(false);
        ...
        _mockFileSystem.Verify(f => f.CreateDirectory(@"C:\ProgramData\Tweaker\Scripts"), Times.Once);
    ...
    public async Task UnregisterScheduledTaskAsync_ComFailure_ReturnsResult()
    {
        ...
        // Will either succeed (Tweaker folder not found => returns Succeeded)
