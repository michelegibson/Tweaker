...
public class UserPreferencesServiceTests
{
    ...
    private const string ConfigDir = @"C:\Users\TestUser\AppData\Local\Tweaker\Config";
    private const string PrefsFilePath = @"C:\Users\TestUser\AppData\Local\Tweaker\Config\UserPreferences.json";
