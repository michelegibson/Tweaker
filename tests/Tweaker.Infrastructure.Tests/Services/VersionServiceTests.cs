...
public class VersionServiceTests
{
    ...
    [Theory]
    [InlineData(@"D:\Tweaker", false)]
    [InlineData(@"D:\Tweaker\", false)]
    [InlineData(@"C:\Program Files\Tweaker", false)]
    [InlineData(@"D:\My Portable\Tweaker", true)]
    [InlineData(@"D:\My Portable\Tweaker\", true)]
    public void BuildInstallerArgs_AlwaysIncludesDirArgPinnedToAppDir(string appDir, bool isPortable)
    {
        ...
        // (regular) or ~\Desktop\Tweaker (portable) regardless of where the
    ...
    {
        // Act
        var args = VersionService.BuildInstallerArgs(@"D:\Portable\Tweaker", isPortable: true);
    ...
    {
        // Act
        var args = VersionService.BuildInstallerArgs(@"C:\Program Files\Tweaker", isPortable: false);
    ...
    public void BuildInstallerArgs_PathWithSpaces_QuotesDirArgCorrectly()
    {
        ...
        var customPath = @"D:\Windows Tweaks\Tweaker";
