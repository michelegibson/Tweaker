...
using Xunit;
using static Tweaker.Infrastructure.Features.SoftwareApps.Services.WinGet.Utilities.WinGetProgressParser;

namespace Tweaker.Infrastructure.Tests.Utilities;
