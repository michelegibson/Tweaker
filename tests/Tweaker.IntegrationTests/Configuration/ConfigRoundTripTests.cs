...
using Tweaker.IntegrationTests.Helpers;
using Xunit;

namespace Tweaker.IntegrationTests.Configuration;
...
public class ConfigRoundTripTests
{
    ...
    [Theory]
    [InlineData("Tweaker_Default_Config_Windows10_22H2.tweaker")]
    [InlineData("Tweaker_Default_Config_Windows11_25H2.tweaker")]
    [InlineData("Tweaker_Recommended_Config.tweaker")]
    public void EmbeddedConfigFile_DeserializesWithoutErrors(string fileName)
    {
        ...
        var configDir = Path.Combine(
            ...
            "src", "Tweaker.UI", "Features", "Common", "Resources", "Configs");
