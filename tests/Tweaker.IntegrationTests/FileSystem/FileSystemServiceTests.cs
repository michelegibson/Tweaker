...
using Tweaker.IntegrationTests.Fixtures;
using Xunit;

namespace Tweaker.IntegrationTests.FileSystem;
...
public class FileSystemServiceTests : IClassFixture<TempDirectoryFixture>
{
    ...
    public async Task WriteAndReadText_RoundTrips()
    {
        ...
        var content = "Hello, Tweaker integration tests!\nLine 2.";
    ...
    public void GetFileName_ExtractsName()
    {
        ...
        _service.GetExtension(@"C:\path\to\file.tweaker").Should().Be(".tweaker");
    }
