...
namespace Tweaker.IntegrationTests.Localization;
...
///       <c>Tweaker.UI.Features.Common.Services.SettingLocalizationService</c>), so a missing key
...
public class LocalizationKeyReferenceTests
{
    ...
    private static readonly string EnJsonPath = Path.Combine(
        TestContext.SolutionDir, "src", "Tweaker.UI", "Features", "Common", "Localization", "en.json");
