...
public class AppItemViewModelTests
{
    ...
    public void AllFallbacks_AreFalse_WhenIconResolved()
    {
        var def = new ItemDefinition
        {
            ...
            Description = "",
            AppxPackageName = new[] { "Microsoft.App1" },
            IconPath = @"C:\Users\test\AppData\Local\Tweaker\IconCache\Microsoft.App1.png",
        };
        var vm = CreateViewModel(def);
    ...
    public void HasIcon_PopulatedIconPath_IsTrue()
    {
        var def = new ItemDefinition
        {
            ...
            Description = "",
            AppxPackageName = new[] { "Microsoft.App1" },
            IconPath = @"C:\Users\test\AppData\Local\Tweaker\IconCache\Microsoft.App1_1.0.0.png",
        };
        var vm = CreateViewModel(def);
    ...
    {
        var tmpDir = Path.Combine(Path.GetTempPath(), "TweakerTest_" + Path.GetRandomFileName());
