...
public class GamingOptimizationsViewModelTests
{
    ...
    public GamingOptimizationsViewModelTests()
    {
    ...
    private GamingOptimizationsViewModel CreateViewModel()
    {
        return new GamingOptimizationsViewModel(
    ...
    [Fact]
    public void ModuleId_ReturnsGamingPerformance()
    {
        // Arrange
        var vm = CreateViewModel();

        // Act & Assert
        vm.ModuleId.Should().Be(FeatureIds.GamingPerformance);
    }

    [Fact]
    public void DisplayName_ReturnsLocalizedGamingPerformanceName()
    {
        // Arrange
        _mockLocalizationService
            .Setup(l => l.GetString("Feature_GamingPerformance_Name"))
            .Returns("Gaming and Performance");

        var vm = CreateViewModel();

        // Act & Assert
        vm.DisplayName.Should().Be("Gaming and Performance");
    }
    ...
    public void ApplySearchFilter_SetsSearchText()
    {
        ...
        // Act
        vm.ApplySearchFilter("gaming");

        // Assert
        vm.SearchText.Should().Be("gaming");
    }
    ...
    {
        // Act
        var action = () => new GamingOptimizationsViewModel(
            null!,
            _mockLogService.Object,
            _mockLocalizationService.Object,
            _mockDispatcherService.Object,
