...
public class MainWindowViewModelTests : IDisposable
{
    ...
    public void Constructor_InitializesDefaultProperties()
    {
        ...
        sut.AppIconSource.Should().Be("ms-appx:///Assets/AppIcons/modune-mark.png");
        sut.VersionInfo.Should().Be("Modune");
    ...
    public void Initialize_SubscribesToThemeChangedEvent()
    {
        ...
        _mockThemeService.Raise(t => t.ThemeChanged += null, this, TweakerTheme.LightNative);
    ...
    public void Initialize_SetsVersionInfo()
    {
        ...
        sut.VersionInfo.Should().Be("Modune v25.05.01");
    }
    ...
    [Fact]
    public void UpdateAppIconForTheme_DarkTheme_SetsBrandIcon()
    {
    ...
    [Fact]
    public void UpdateAppIconForTheme_LightTheme_SetsBrandIcon()
    {
        _mockThemeService.Setup(t => t.GetEffectiveTheme()).Returns(ElementTheme.Light);
        var sut = CreateSut();
    ...
    {
        var sut = CreateSut();
        sut.AppSubtitle.Should().Be("Windows Control Studio");
    }

    [Fact]
    public void NavSystemSectionText_ReturnsFallbackWhenLocalizationReturnsNull()
    {
        var sut = CreateSut();

        sut.NavSystemSectionText.Should().Be("System");
    }
    ...
    public void LanguageChanged_NotifiesLocalizedStringProperties()
    {
        ...
        changedProperties.Should().Contain(nameof(sut.NavSystemSectionText));
    }
