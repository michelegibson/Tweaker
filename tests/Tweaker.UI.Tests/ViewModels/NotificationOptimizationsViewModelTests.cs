...
public class NotificationOptimizationsViewModelTests
{
    ...
    public NotificationOptimizationsViewModelTests()
    {
    ...
    private NotificationOptimizationsViewModel CreateViewModel()
    {
        return new NotificationOptimizationsViewModel(
