...
public class SettingItemViewModelTests : IDisposable
{
    ...
    public void UpdateStatusBanner_WithOptionWarning_SetsErrorBanner()
    {
        ...
        var settingDef = new SettingDefinition
        {
            ...
            ComboBox = new ComboBoxMetadata
            {
                Options = new[]
                {
                    new Tweaker.Core.Features.Common.Models.ComboBoxOption
                    {
    ...
    public void UpdateStateFromSystemState_Selection_SeparateACDC_UpdatesBothIndices()
    {
        var settingDef = new SettingDefinition
        {
            ...
            ComboBox = new ComboBoxMetadata
            {
                Options = new[]
                {
                    new Tweaker.Core.Features.Common.Models.ComboBoxOption { DisplayName = "Option A", ValueMappings = new Dictionary<string, object?> { { "PowerCfgValue", 10 } } },
                    new Tweaker.Core.Features.Common.Models.ComboBoxOption { DisplayName = "Option B", ValueMappings = new Dictionary<string, object?> { { "PowerCfgValue", 20 } } },
                    new Tweaker.Core.Features.Common.Models.ComboBoxOption { DisplayName = "Option C", ValueMappings = new Dictionary<string, object?> { { "PowerCfgValue", 30 } } }
                }
            },
            PowerCfgSettings = new List<PowerCfgSetting>
            {
    ...
    {
        var list = new List<Tweaker.Core.Features.Common.Models.ComboBoxOption>();
        foreach (var (name, v, rec, def) in options)
        {
            list.Add(new Tweaker.Core.Features.Common.Models.ComboBoxOption
            {
                DisplayName = name,
        ...
        return new SettingDefinition
        {
            ...
            RegistrySettings = new[]
            {
                new RegistrySetting
                {
                    KeyPath = @"HKEY_CURRENT_USER\Software\Tweaker\Test",
                    ValueName = "V",
