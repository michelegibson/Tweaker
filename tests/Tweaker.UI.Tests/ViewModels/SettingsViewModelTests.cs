...
using Tweaker.UI.Features.Settings.ViewModels;
using Xunit;
...
public class SettingsViewModelTests
{
    ...
    public void Constructor_LoadsCurrentTheme()
    {
        _mockThemeService
            .Setup(t => t.CurrentTheme)
            .Returns(TweakerTheme.DarkNative);

        var vm = CreateViewModel();

        vm.SelectedTheme.Should().Be(TweakerTheme.DarkNative);
    }
    ...
    public void Constructor_InitializesThemesCollection_WithThreeOptions()
    {
        ...
        vm.Themes.Select(t => t.Theme).Should().Contain(TweakerTheme.System);
        vm.Themes.Select(t => t.Theme).Should().Contain(TweakerTheme.LightNative);
        vm.Themes.Select(t => t.Theme).Should().Contain(TweakerTheme.DarkNative);
    }
    ...
    public void Constructor_SetsSelectedThemeOption_MatchingCurrentTheme()
    {
        _mockThemeService
            .Setup(t => t.CurrentTheme)
            .Returns(TweakerTheme.LightNative);

        var vm = CreateViewModel();

        vm.SelectedThemeOption.Should().NotBeNull();
        vm.SelectedThemeOption!.Theme.Should().Be(TweakerTheme.LightNative);
    }
    ...
    public void SelectedTheme_SetToNewValue_CallsThemeServiceSetTheme()
    {
        ...
        vm.SelectedTheme = TweakerTheme.DarkNative;

        _mockThemeService.Verify(t => t.SetTheme(TweakerTheme.DarkNative), Times.Once);
    }
    ...
    public void SelectedTheme_SetToSameAsCurrentTheme_DoesNotCallSetTheme()
    {
        ...
        vm.SelectedTheme = TweakerTheme.System;

        _mockThemeService.Verify(t => t.SetTheme(It.IsAny<TweakerTheme>()), Times.Never);
    }
    ...
    {
        var vm = CreateViewModel();
        var darkOption = vm.Themes.First(t => t.Theme == TweakerTheme.DarkNative);
    ...
    public void OnLanguageChanged_UpdatesThemeDisplayNames()
    {
        ...
        var systemTheme = vm.Themes.First(t => t.Theme == TweakerTheme.System);
        systemTheme.DisplayText.Should().Be("Systeme");

        var lightTheme = vm.Themes.First(t => t.Theme == TweakerTheme.LightNative);
        lightTheme.DisplayText.Should().Be("Clair");

        var darkTheme = vm.Themes.First(t => t.Theme == TweakerTheme.DarkNative);
