...
public class TaskbarCustomizationsViewModelTests
{
    ...
    private TaskbarCustomizationsViewModel CreateViewModel()
    {
        return new TaskbarCustomizationsViewModel(
    ...
    [Fact]
    public void ModuleId_ReturnsTaskbar()
    {
        // Arrange
        var vm = CreateViewModel();

        // Act & Assert
        vm.ModuleId.Should().Be(FeatureIds.Taskbar);
    }

    [Fact]
    public void DisplayName_ReturnsLocalizedTaskbarName()
    {
        // Arrange
        _mockLocalizationService
            .Setup(l => l.GetString("Feature_Taskbar_Name"))
            .Returns("Taskbar");

        var vm = CreateViewModel();

        // Act & Assert
        vm.DisplayName.Should().Be("Taskbar");
    }
    ...
    public void ApplySearchFilter_SetsSearchText()
    {
        ...
        // Act
        vm.ApplySearchFilter("taskbar");

        // Assert
        vm.SearchText.Should().Be("taskbar");
    }
    ...
    {
        // Act
        var action = () => new TaskbarCustomizationsViewModel(
            null!,
            _mockLogService.Object,
            _mockLocalizationService.Object,
            _mockDispatcherService.Object,
