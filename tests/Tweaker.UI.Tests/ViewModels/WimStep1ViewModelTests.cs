...
public class WimStep1ViewModelTests
{
    ...
    [Fact]
    public void Constructor_InitializesWorkingDirectoryToTempTweakerWIM()
    {
        _sut.WorkingDirectory.Should().Be("C:\\Temp\\TweakerWIM");
    }
    ...
    public async Task SelectWorkingDirectoryCommand_WhenNotExtractedAlready_CreatesSubDirectory()
    {
        ...
        _mockFileSystemService.Verify(f => f.CreateDirectory("D:\\WorkDir\\TweakerWIM"), Times.Once);
        _sut.WorkingDirectory.Should().Be("D:\\WorkDir\\TweakerWIM");
    }
