...
using Tweaker.UI.Features.AdvancedTools.ViewModels;
...
public class WimStep2XmlViewModelTests : IDisposable
{
    ...
    {
        _sut.GenerateTweakerXmlCard.Should().NotBeNull();
    ...
    {
        _sut.GenerateTweakerXmlCard.IsEnabled.Should().BeTrue();
    ...
    [Fact]
    public async Task GenerateTweakerXmlCommand_WhenWorkingDirectoryEmpty_ShowsWarningAndReturns()
    {
        // WorkingDirectory defaults to empty
        await _sut.GenerateTweakerXmlCommand.ExecuteAsync(null);
    ...
    // ── GenerateTweakerXml command ──

    [Fact]
    public async Task GenerateTweakerXmlCommand_WhenUserCancels_DoesNotGenerate()
    {
    ...
    [Fact]
    public async Task GenerateTweakerXmlCommand_OnSuccess_SetsIsXmlAdded()
    {
        _sut.WorkingDirectory = "C:\\WorkDir";
        _mockDialogService
            .Setup(d => d.ShowConfirmationAsync(It.IsAny<ConfirmationRequest>()))
        ...
        _sut.GenerateTweakerXmlCard.IsComplete.Should().BeTrue();
    }

    [Fact]
    public async Task GenerateTweakerXmlCommand_OnSuccess_ClearsOtherCardCompletions()
    {
        _sut.WorkingDirectory = "C:\\WorkDir";
    ...
    [Fact]
    public async Task GenerateTweakerXmlCommand_OnException_SetsHasFailed()
    {
        _sut.WorkingDirectory = "C:\\WorkDir";
        _mockDialogService
            .Setup(d => d.ShowConfirmationAsync(It.IsAny<ConfirmationRequest>()))
        ...
        _sut.GenerateTweakerXmlCard.HasFailed.Should().BeTrue();
    }
    ...
    {
        _sut.WorkingDirectory = "C:\\WorkDir";
        _sut.GenerateTweakerXmlCard.IsComplete = true;
        _sut.SelectXmlCard.IsComplete = true;
        ...
        _sut.GenerateTweakerXmlCard.IsComplete.Should().BeFalse();
        _sut.SelectXmlCard.IsComplete.Should().BeFalse();
        _sut.DownloadXmlCard.IsComplete.Should().BeTrue();
    }
