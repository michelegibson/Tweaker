...
public class WimUtilViewModelTests : IDisposable
{
    ...
    {
        // Step1 sets WorkingDirectory in its constructor to TempPath\TweakerWIM.
    ...
    [Fact]
    public void GenerateTweakerXmlCommand_ForwardsToStep2()
    {
        _sut.GenerateTweakerXmlCommand.Should().BeSameAs(_sut.Step2.GenerateTweakerXmlCommand);
    }
