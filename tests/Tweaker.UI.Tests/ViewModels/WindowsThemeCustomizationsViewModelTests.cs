...
public class WindowsThemeCustomizationsViewModelTests
{
    ...
    public WindowsThemeCustomizationsViewModelTests()
    {
    ...
    private WindowsThemeCustomizationsViewModel CreateViewModel()
    {
        return new WindowsThemeCustomizationsViewModel(
    ...
    [Fact]
    public void ModuleId_ReturnsWindowsTheme()
    {
        // Arrange
        var vm = CreateViewModel();

        // Act & Assert
        vm.ModuleId.Should().Be(FeatureIds.WindowsTheme);
    }

    [Fact]
    public void DisplayName_ReturnsLocalizedWindowsThemeName()
    {
        // Arrange
        _mockLocalizationService
            .Setup(l => l.GetString("Feature_WindowsTheme_Name"))
            .Returns("Windows Theme");

        var vm = CreateViewModel();

        // Act & Assert
        vm.DisplayName.Should().Be("Windows Theme");
    }
    ...
    public void ApplySearchFilter_SetsSearchText()
    {
        ...
        // Act
        vm.ApplySearchFilter("theme");

        // Assert
        vm.SearchText.Should().Be("theme");
    }
    ...
    {
        // Act
        var action = () => new WindowsThemeCustomizationsViewModel(
            null!,
            _mockLogService.Object,
            _mockLocalizationService.Object,
            _mockDispatcherService.Object,
